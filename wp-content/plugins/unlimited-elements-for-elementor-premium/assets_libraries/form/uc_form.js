  ...
  */
  t.init = function(){
    ...
    g_objCalcInputs.each(function(){
      ...
      //   var objOption = jQuery(this); //triggered input
      //   var objParentCalkInput = getParentCalcInput(objOption); //parent calc input with formula attr
      ...
      //   setResult(objParentCalkInput, objError);
